...
<body>
	...
	<!--body-->
    <div class="container top-margin height">
      <div class="card mar border-primary">
        ...
        <div class="card-body mb-5">
          ...
          <input class="btn btn-primary " value="Login" type="submit" name="button" >
        </div>
        </form>
        <div class="card-footer">Don't have an account?<a href="signup 1.php">Register</a></div>
      </div>
    </div>
  <!--end body-->
  ...
  <footer class="text-center">
      <p class="text-white bg-dark mb-0 pt-3 pb-3">Copyright © Lifestyle Store. All Rights Reserved | Contact Us: +91 90000 00000</p>
  </footer>
  <!--end of footer-->
